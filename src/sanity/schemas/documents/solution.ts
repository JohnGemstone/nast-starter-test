...
export const solution = defineType({
  ...
  fields: [
    defineField({
      ...
      title: "Name",
      type: "string",
      description: "Name of the solution. Used for navigation and menus.",
      group: ["content", "seo"],
    ...
    defineField({
      ...
      options: {
        ...
        maxLength: 30,
        //@ts-expect-error
        urlPrefix: 'lcdshowcase.uk/solutions/',
      },
      group: "seo",
      validation: Rule => Rule.required(),
      components: {
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          description: "Text that appears in the header. Must contain a heading (H1).",
          validation: Rule => Rule.required(),
        }),
        defineField({
          name: "CTA",
          ...
          type: 'string',
          description: "Text for the CTA button. Defaults to 'Start Your Project'",
